...
if (isset($_GET['modifier'])) //si on appuie sur modifier, on crée une variable $news stockant une seule news avec l'id correspondant
{
...
{
?>
        <input type="hidden" name="id" value="<?= $news->id() //return id transmit depuis le click modifier?>" /> 
